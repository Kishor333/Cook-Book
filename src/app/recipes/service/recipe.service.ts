...
export class RecipeService {
  ...
  //       imgPath:'./assets/images/rec1.webp',
  //       ingredient: [
  //         {name:'Chees', amount:1},
  //         {name:'Pasta', amount:2},
  //       ]
  ...
  //      imgPath:'./assets/images/choco.webp',
  //     ingredient:[
  ...
  //     imgPath:'./assets/images/salmon.webp',
  //     ingredient:[
  //       {name:'salad', amount:3},
  //       {name:'yuna', amount:1},
  //     ]
  ...
  //       imgPath:'./assets/images/humus.webp',
  //     ingredient:[
  ...
  //       imgPath:'./assets/images/potato.webp',
  //     ingredient:[
  ...
  //       imgPath:'./assets/images/flatbread.webp',
  //     ingredient:[
  //       {name:'Flour', amount:1},
  //         {name:'Sauce', amount:2},
  //     ]
  ...
  //       imgPath:'./assets/images/chickenkuffat.webp',
  //     ingredient:[
  ...
  setRecipe(recipe: Recipe[]) {
    this.recipy = recipe;
    this.recipeChange.next(this.recipy.slice());
  }
  ...
  addNewRecipe(newRecipe: Recipe) {
    this.recipy.push(newRecipe);
    this.recipeChange.next(this.recipy.slice());

  };

  deleteRecipy(recIndex:number) {
    this.recipy.splice(recIndex, 1);
    this.recipeChange.next(this.recipy.slice());
  }

  // deleteIngredient(recIndex:number, ingIndex:number) {
  //   // console.log(this.recipy[recIndex].ingredient[ingIndex]);

  //   this.recipy[recIndex].ingredient.splice(ingIndex, 1);

  //   this.recipeChange.next(this.recipy.slice());
  //   // console.log(this.recipy[recIndex].ingredient);
  // }

  updateRecipe(index:number, updatedRecipe:Recipe) {
    this.recipy[index] = updatedRecipe;
    this.recipeChange.next(this.recipy.slice())
  }
}
